...
提示:默认情况下不安装 ggplot2 包。请参考[安装 R 包](https://www.tutorialgateway.org/install-r-packages/)一文在 [R 编程](https://www.tutorialgateway.org/r-programming/)中安装一个包。
...
*   填充:请指定点绘图要使用的颜色。在控制台中键入 colors()以获取 R 编程中可用的颜色列表
*   颜色:为点的边框指定颜色
