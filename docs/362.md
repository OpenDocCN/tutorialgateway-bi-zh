...
幂 BI 中的 DAX SINH 函数返回双曲正弦值。PowerBI DAX 正弦函数的语法是:
...
幂 BI DAX ASIN 函数返回反正弦值或反弦值。PowerBI DAX ASIN 函数的语法是:
...
幂 BI DAX TAN 函数返回正切值。PowerBI DAX TAN 函数语法为:
...
幂 BI DAX TANH 函数返回双曲正切值。该PowerBI DAX TANH 函数的语法如下所示:
...
幂 BI DAX LN 函数返回给定数字的自然对数值。PowerBI DAX LN 函数的语法是:
...
Power BI 中的 DAX LOG 函数返回给定数字的对数值。该函数接受第二个参数来指定基值。PowerBI数据交换日志函数的语法是:
