...
### 步骤 1:创建一个信息源定义，将多个文本文件加载到 SQL Server 中
...
将“员工 1”源定义从“源”文件夹拖放到映射设计器中。拖动源后，动力中心设计师会自动为您创建[源限定符变换](https://www.tutorialgateway.org/source-qualifier-transformation-in-informatica/)。
