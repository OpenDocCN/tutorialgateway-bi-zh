...
以下是“显示项目时显示值”部分下的“测量”选项上的功率商业智能过滤器列表:
...
让我在“销售额”列中使用多个过滤器。第一个筛选器查找销售额大于 300000 的州，第二个筛选器查找销售额小于 2300000 的州。
