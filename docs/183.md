...
在本例中，我们将向条形图中添加表格参考线。首先，将颜色、英文产品名称从维度区域拖放到列架，将销售额从度量区域拖放到行架。默认情况下，Tableau 将生成条形图。

![Add Reference Lines in Tableau 1](img/9dde9f96f54776eeee4f3e1f1d14a01c.png)

要在表格中添加参考线，右键单击销售金额轴将打开上下文菜单。请从上下文菜单
...
*   整个表格:如果选择此选项，表格将计算整个表格的聚合，并为整个表格添加参考线
*   每个窗格:它将计算表中各个窗格的聚合，并将参考线添加到各个窗格中
*   每个单元格:选择此选项可计算表格内单个单元格的聚合，并向单个单元格添加参考线

![Add Reference Lines in Tableau 0](img/c44fc31c4cee5a1d8fe94b9e81d32e21.png)

### 向表格中的整个表格添加参考线

要将表格参考线添加到整个表格，请在范围区域中选择整个表格选项。从下面的截图可以观察到，整个表格里面可用的选项参考线选项
...
*   无:如果选择此选项，则表格不会显示参考线的任何标签
*   值:如果选择此选项，则表格将显示选择作为参考线标签的度量的聚合值
*   计算:如果选择此选项，则表将显示聚合函数名或度量名作为参考线的标签
*   自定义:如果选择此选项，则表格将显示您在文本框中指定的自定义值，作为参考线的标签
...
单击“确定”完成向项目符号图添加参考线。下面的截图将显示整个表格的参考线
...
要删除表格中的参考线，右键单击销售金额轴将打开上下文菜单。我们有多个选项来删除参考线，如下所示。例如，

*   如果表格报告仅包含一条参考线，请选择删除参考线选项。
...
要为每个窗格添加表格参考线，请在范围区域中选择每个窗格选项。从下面的截图中你可以观察到我们没有用【线】或【格式】
...
要添加每个单元格的表格参考线，请在范围区域中选择每个单元格选项。从下面的截图中你可以观察到我们没有用【线】或【格式】
...
从上面的截图中，您可以注意到 Tableau 正在计算单个单元格的平均值，而不是整个表格或窗格的平均值

### 编辑表格中的参考线

要编辑现有的表格参考线，右键单击销售金额轴打开上下文菜单。请从上下文菜单中选择编辑参考线选项。
