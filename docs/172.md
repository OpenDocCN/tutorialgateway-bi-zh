...
接下来，请点击“行货架销售金额测量”并选择“快速表格计算”选项，然后选择“累计”来计算累计
...
为了达到同样的效果，我们必须将销售金额轴从累计金额更改为总额的百分比。为此，请单击销售额度量旁边的向下箭头，并选择编辑表格计算选项

![How to Create Pareto Chart 5](img/3ef78c99b33ccca00110a965e3b35135.png)

选择“编辑表格计算”选项后，将会打开以下“表格排列图”窗口。

*   请将“沿表运行”选项从“跨表”更改为“客户全名”字段。它根据客户名称而不是表格来计算累计金额。
...
右键单击表格帕累托图度量区域中的空白区域。现在，请从上下文菜单中选择创建计算字段选项。
