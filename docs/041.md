...
### 创建Informatica SQL 转换映射

要为Informatica SQL 转换创建新映射，请导航到映射菜单并选择创建..选项。
...
单击创建按钮将弹出一个名为Informatica SQL 转换的新窗口。
...
最后，我们必须配置Informatica SQL 转换。因此，点击[转换](https://www.tutorialgateway.org/informatica-transformations/)文件夹中的 SQL_Employee。
