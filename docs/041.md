...
在连接中，单击关系类型旁边的箭头按钮，并使用连接变量$Source。因为我们使用[选择语句](https://www.tutorialgateway.org/sql-select-statement/)从信息源中选择记录。
...
现在，让我开始信息工作流中的 SQL 转换。为此，请导航到“工作流”菜单并选择“启动工作流”选项。
